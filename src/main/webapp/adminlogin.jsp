...
<html>
  ...
  <body>
	  <div id="login-page">
	  	<div class="container">
		      <form class="form-login" action="adminlogin.html" method="post">
		        <h2 class="form-login-heading">管理员管理系统</h2>
		        <div class="login-wrap"><!-- required 必填， autofocus 光标锁定-->
		            <input type="text" class="form-control" placeholder="请输入管理员名" name="adname" required autofocus>
		            <br>
